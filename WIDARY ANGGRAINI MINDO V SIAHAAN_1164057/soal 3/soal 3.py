...
w=shapefile.Writer(shapeType=1) #mendeklarasikan variable
w.shapeType #menjalankan perintah dari sih variable
w.shapeType=3   #menjalankan perintah dari sih variable
w.shapeType #menjalankan perintah dari sih variable
...
w.save("soal3") #untuk menyimpan dengan format file.shp